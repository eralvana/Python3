...
alumno1=Estudiante(nombrea='Alejandro', apellidoa=' Bermudez')
print(alumno1)
session.add(alumno1)
alumno1.cursos=Course(nombrec='Canto')
print(alumno1.cursos)

horario1=Crono(dia='lunes',hora_inicio=" 8:00 am", hora_fin=' 10:00 am')
session.add(horario1)
horario1.curso_hora=Course(nombrec='Español')
horario1.curso_profe=Maestro(nombrep='Francisco',apellidop=' Gutiérrez')
